...
- **Reference:** `docs/MASTER_BACKLOG.md` §3 P1 #14 (audit_log + audit-logger worker) + V012 spec: `docs/archive-v1/02_DATA_MODEL.md` §1.X; `docs/00_CONTEXT.md` §2 (audit-logger boundary); `docs/LOG_CATALOG.md`.
