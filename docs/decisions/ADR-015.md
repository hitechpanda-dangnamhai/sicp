...
- **Reference:** `apps/web/components/icp/` (component library built) + `apps/web/app/globals.css` (tokens v3) + `docs/archive-v1/phases/PHASE_00_DESIGN_SYSTEM.md` (design spec).
