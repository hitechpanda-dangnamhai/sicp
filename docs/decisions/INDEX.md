...
| [ADR-056](ADR-056.md) | CI posture LLM-driven e2e: non-blocking live job | Accepted | deterministic e2e=hard-gate; LLM-e2e=job CI non-blocking (live structural, report, không fail pipeline); regression intent dựa T04 eval; tôn §0.5 (boot deterministic gồm MCP, T02c) |
