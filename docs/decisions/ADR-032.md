...
- **Reference:**
  ...
  - MCP tool spec update: `docs/00_CONTEXT.md` §2 (service boundary, MCP) + `apps/mcp/src/tools/shopee.py`
  - Schema doc: `infra/migrations/V008__shopee_prices_mock.sql` + `docs/archive-v1/02_DATA_MODEL.md` §X
