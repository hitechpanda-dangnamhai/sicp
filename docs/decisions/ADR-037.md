...
- **Reference:** `docs/00_CONTEXT.md` v3.0 (§1 mục tiêu production, §3 pillar 10 multi-tenant) + `docs/archive-v1/00_CONTEXT.md` (v1.x/v2.0 lịch sử pivot). (`SESSION_HANDOFF_state.md` + `HANDOFF_PROMPT_production-docs-reconcile.md` = orphan refs từ trước Workflow v2, không có nhà mới — historical only.)
