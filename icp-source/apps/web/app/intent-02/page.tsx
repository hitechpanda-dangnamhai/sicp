/**
 * apps/web/app/intent-02/page.tsx — Placeholder for Intent 02 (Mua hàng).
 *
 * Slice:    S-03 T03b — Home Dashboard hub (placeholder routes per R1 mapping)
 * Mapping:  → /intent-02 → future S-08 V-SLICE owner
 *
...
export default function Intent02PlaceholderPage() {
  return (
    <div className="min-h-screen bg-pink-50/40 flex flex-col items-center justify-center px-6 text-center">
      <div className="text-6xl mb-4">🛍️</div>
      <h1 className="text-[20px] font-bold text-rose-900 mb-2">Mua hàng (Intent 02)</h1>
      <p className="text-[13px] text-pink-700 mb-6 max-w-xs">
        Tính năng đặt hàng bằng giọng nói cho khách đang được phát triển. Vui lòng quay lại sau.
      </p>
      <Link
        href="/home"
