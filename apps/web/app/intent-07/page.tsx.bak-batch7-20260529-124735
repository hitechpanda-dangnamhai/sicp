/**
 * apps/web/app/intent-07/page.tsx — Placeholder for Intent 07 (Phân tích).
 *
 * Slice:    S-03 T03b — Home Dashboard hub (placeholder routes per R1 mapping)
 * Mapping:  → /intent-07 → future S-10 V-SLICE owner
 *
...
export default function Intent07PlaceholderPage() {
  return (
    <div className="min-h-screen bg-pink-50/40 flex flex-col items-center justify-center px-6 text-center">
      <div className="text-6xl mb-4">📊</div>
      <h1 className="text-[20px] font-bold text-rose-900 mb-2">Phân tích kinh doanh (Intent 07)</h1>
      <p className="text-[13px] text-pink-700 mb-6 max-w-xs">
        Tính năng phân tích trend doanh thu, tồn kho đang được phát triển. Vui lòng quay lại sau.
      </p>
      <Link
        href="/home"
