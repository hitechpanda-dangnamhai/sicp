...
/**
 * apps/web/components/icp/atoms/OrbPulse.stories.tsx
 *
 * Story stub for <OrbPulse> atom — per T02 AC-17 (D-02 Storybook 8).
...
const meta: Meta<typeof OrbPulse> = {
  title: 'Atoms/OrbPulse',
  component: OrbPulse,
};

export default meta;
type Story = StoryObj<typeof OrbPulse>;
